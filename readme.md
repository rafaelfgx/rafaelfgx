...
**Hello! I am thrilled to have you here, exploring my projects!**

**This space is designed to share my knowledge and experience!**

**I hope you enjoy the journey and find plenty of inspiration along the way!**

<img src="https://github-profile-trophy.vercel.app/?theme=onedark&no-bg=true&no-frame=true&rank=SECRET,SSS,SS,S,AAA,AA,A&username=rafaelfgx" alt="rafaelfgx" />
...
**.NET 9 Nuget Packages:** **https://www.nuget.org/profiles/rafaelfgx**
...
**API using Java 23, Spring Boot 3, Docker, Testcontainers, PostgreSQL, MongoDB, Kafka, LocalStack, SQS, S3, JWT, Swagger.**
...
- **[Send your message](https://forms.gle/ZsXtYmsMK2713x3k7) | [Envie sua mensagem](https://forms.gle/ZsXtYmsMK2713x3k7)**